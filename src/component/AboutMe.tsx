            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='w-96 md:w-3/4'>
                    <div className='mt-5 text-2xl md:text-4xl'>
                        <span className='font-bold text-indigo-600'>Xin chào! tôi tên</span>
                        <span className='font-bold bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent ml-2'>Đào Ngọc Hòa,</span>
                        <span className='font-bold ml-2 text-indigo-600'>một sinh viên đại học thuộc chuyên ngành</span>
                        <span className='font-bold ml-2 text-indigo-600'>công nghệ phần mềm</span>
                        <span className='font-bold ml-2 text-indigo-600'>tại đại học Tài nguyên và Môi trường Hồ Chí Minh.</span>
                    </div>
                    <div className='mt-5 text-2xl md:text-4xl'>
                        <span className='font-bold text-indigo-600'>Tôi có kinh nghiệm làm</span>
                        <span className='font-bold bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent ml-2'>ứng dụng web full-stack.</span>
                        <span className='font-bold ml-2 text-indigo-600'>Ngoài ra tôi cũng có kiến thức và kỹ năng giải quyết vấn đề về</span>
                        <span className='font-bold bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent ml-1'>cấu trúc dữ liệu & giải thuật</span>
                        <span className='font-bold ml-2 text-indigo-600'>và các kỹ năng về</span>
                        <span className='font-bold bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent ml-2'>OPP.</span>
                    </div>
                        ...
                        <div>
                            <div className='flex flex-col mt-5 w-full justify-center items-center border-t-4 border-indigo-500'>
                                <div className='font-bold text-3xl text-indigo-600 justify-center h-auto w-auto mt-5 flex flex-col md:flex-row'>
                                    ...
                                    <div className='flex flex-col h-96 w-48 m-5 mb-16'>
                                        <span className='font-bold text-3xl text-indigo-600 flex justify-center'>Công nghệ</span>
                                    ...
                                    <div className='flex flex-col w-48 m-5'>
                                        <span className='font-bold text-3xl text-indigo-600 justify-center'>Cơ sở dữ liệu</span>
                                    ...
                                    <div className='flex flex-col w-48 m-5'>
                                        <span className='font-bold text-3xl text-indigo-600 justify-center'>Công cụ</span>
                                        <li className='flex flex-col justify-center items-center'>
